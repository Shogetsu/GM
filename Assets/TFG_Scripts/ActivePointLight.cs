...
public class ActivePointLight : NetworkBehaviour {
    ...
    void UpdateLight(bool a)
    {
        ...
        if (a)
        {
            ...
            endTime = GetTotalTime() + 10800; // 3600s = 1h dura la iluminacion | El tiempo total transcurrido es importante para evitar bug cuando termina el dia (a las 00:00 la variable time se resetea a 0)
        }
        else
        {
