...
namespace Prototype.NetworkLobby
{
    ...
    {
        static Color[] Colors = new Color[] { Color.magenta, Color.white, Color.red, Color.cyan, Color.blue, Color.green, Color.yellow};
        ...
        public Color EvenRowColor = new Color(1.0f, 1.0f, 1.0f, 1.0f);
